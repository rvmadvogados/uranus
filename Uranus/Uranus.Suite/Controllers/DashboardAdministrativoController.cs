    ...
    public class DashboardAdministrativoController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            else
            {
                ...
                var solicitacoes = ProfissionaisSolicitacoesBo.ListarDashboard();
                performance.DashProfissionaisSolicitacoes = solicitacoes;

                var solicitacoesespeciais = ProfissionaisSolicitacoesEspeciaisBo.ListarDashboard();
                performance.DashProfissionaisSolicitacoesEspeciais = solicitacoesespeciais;

                var ausencias = ProfissionaisAusenciasBo.ListarDashboard();
                performance.DashProfissionaisAusencias = ausencias;

                var documentos = ProfissionaisDocumentosBo.ListarDashboard();
                performance.DashProfissionaisDocumentos = documentos;
