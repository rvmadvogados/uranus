    ...
    public class RelatorioClientesEtiquetasController : Controller
    {
        ...
        public ActionResult Index(List<int> FiltrarSedes = null)
        {
            ...
            else
            {
                ...
                viewer.LocalReport.ReportPath = Request.MapPath(Request.ApplicationPath) + @"Reports\rptEtiquetas.rdlc";
                viewer.LocalReport.DataSources.Add(new Microsoft.Reporting.WebForms.ReportDataSource("dsEtiqueta", ds));
