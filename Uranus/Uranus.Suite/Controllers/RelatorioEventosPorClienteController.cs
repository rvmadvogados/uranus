...
namespace Uranus.Suite.Controllers
{
    ...
    public class RelatorioEventosPorClienteController : Controller
    {
        ...
        public ActionResult Index(String FiltrarDataInicio = null, String FiltrarDataFim = null, List<int> FiltrarProfissionais = null)  /*, List<int> FiltrarTiposEventos = null*/
        {
            ...
            else
            {
                ...
                {
                    PrepararRelatório(FiltrarDataInicio, FiltrarDataFim, FiltrarProfissionais);  /*, FiltrarTiposEventos*/
                }
        ...
        private void PrepararRelatório(string FiltrarDataInicio, string FiltrarDataFim, List<int> FiltrarProfissionais)   /*, List<int> FiltrarTiposEventos*/
        {
