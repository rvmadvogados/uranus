! function () {
	...
	if (window.jQuery && jQuery.fn && jQuery.fn.select2 && jQuery.fn.select2.amd)
		var e = jQuery.fn.select2.amd.define,
	...
	! function (r) {
		...
		return n.Extend(r, t), r.prototype.render = function () {
			...
			var t = e('<li class="select2-selection__choice"><span class="select2-selection__choice__remove" role="presentation">×</span></li>');
			return t
		}, r.prototype.update = function (e) {
		...
		return t.prototype.bind = function (t, n, r) {
			...
			if (t.call(this, n), !(this.$selection.find(".select2-selection__placeholder").length > 0 || 0 === n.length)) {
				var r = e('<span class="select2-selection__clear">×</span>');
		...
		return {
			...
			inputTooShort: function (e) {
				var t = e.minimum - e.input.length,
					n = "Informe " + t + " ou mais caracteres";
				return n
			},
			...
			maximumSelected: function (e) {
				var t = "Você só pode selecionar " + e.maximum + " iten";
